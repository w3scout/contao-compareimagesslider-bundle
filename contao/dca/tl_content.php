...
// ToDo: Add
// https://img-comparison-slider.sneas.io/examples.html#before-and-after-labels
...
[
    ...
    'exclude' => true,
    'inputType' => 'fileTree',
    'eval' => ['filesOnly' => true, 'fieldType' => 'radio', 'mandatory' => true, 'tl_class' => 'w50'],
    'sql' => 'binary(16) NULL',
];
...
$GLOBALS['TL_DCA']['tl_content']['fields']['default_offset_pct'] =
[
    'label' => &$GLOBALS['TL_LANG']['tl_content']['default_offset_pct'],
    'exclude' => true,
    'inputType' => 'text',
    'eval' => ['mandatory' => true, 'rgxp' => 'digit', 'maxlength' => 3, 'tl_class' => 'clr w50'],
    'sql' => "varchar(3) NOT NULL default ''",
];
$GLOBALS['TL_DCA']['tl_content']['fields']['vertical_mode'] =
[
...
$GLOBALS['TL_DCA']['tl_content']['fields']['auto_hover'] =
[
